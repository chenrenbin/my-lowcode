...
<script lang="tsx" setup>
  ...
  import { $$dropdown, DropdownOption } from '@/utils/dropdown-service.tsx';
  import MonacoEditor from '@/views/editor/components/common/monaco-editor/MonacoEditor';
  import { useGlobalProperties } from '@/hooks/useGlobalProperties';
  import { useVisualData } from '@/views/editor/hooks/useVisualData';
  import { useModal } from '@/views/editor/hooks/useModal';
  import { generateNanoid } from '@/views/editor/utils';

  defineOptions({ name: 'editorFactory', });

  const { currentPage, setCurrentBlock } = useVisualData() || {};
console.log('currentPage', currentPage.blocks)
